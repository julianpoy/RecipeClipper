...
import * as ElementUtils from './utils/element'
import * as ClipUtils from './utils/clip'

describe('clip', () => {
  let clipImageURLSpy, clipTitleSpy, clipDescriptionSpy, clipSourceSpy, clipYieldSpy, clipActiveTimeSpy
  let clipTotalTimeSpy, clipIngredientsSpy, clipInstructionsSpy, clipNotesSpy
  let outputVal
